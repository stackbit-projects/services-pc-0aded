              ...
              <div className="container container--lg">
                <div className={'grid post-feed post-feed--col-' + col_number}>
                  ...
                  <article key={post_idx} className="cell post-card">
                    ...
                    <Link className="post-card__image" href={withPrefix(_.get(post, '__metadata.urlPath', null))}>
                      <img src={withPrefix(_.get(post, 'frontmatter.thumb_image', null))} alt={_.get(post, 'frontmatter.thumb_image_alt', null)} />
                    </Link>
                    )}
                    <header className="post-card__header">
                      <h2 className="post-card__title"><Link href={withPrefix(_.get(post, '__metadata.urlPath', null))}>{_.get(post, 'frontmatter.title', null)}</Link></h2>
