    ...
    render() {
        ...
        return (
            ...
            <article className="project">
              <header className="project__header">
                <div className="container container--md">
                  <h1 className="project__title line-top">{_.get(this.props, 'page.frontmatter.title', null)}</h1>
            ...
            _.map(projects_sorted, (project_item, project_item_idx) => (
              (_.get(project_item, '__metadata.urlPath', null) === _.get(this.props, 'page.__metadata.urlPath', null)) && ((() => {
